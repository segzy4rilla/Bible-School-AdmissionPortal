            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 box-margin">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-2">UD Bishops Summary Table</h4>
                                ...
                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        <th>Denomination</th>
                                        <th>Council</th>
                                        <th>Bishop In Charge</th>
                                        <th>Number Of Potential Students</th>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>" . $row['Council'] . "</td>";
                                        echo "<td>" . $row['Bishop_In_Charge'] . "</td>";
                                        echo "<td>" . $row['Num_Pot'] . "</td>";
                                        echo "</tr>";
                                    }
