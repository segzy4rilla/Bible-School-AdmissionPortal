...
if ($_SESSION['loggedin'] == false || !$_SESSION['IsNationsAdmin']) {
...
<head>
    ...
    <!-- Title -->
    <title>ABMTC - 190 Nations Staff Home</title>
        ...
        <div class="container-fluid" style="height:100%">
            <div class="row" style="height:100%">
                ...
                <div class="col-lg-12" style="height:30%">
                    <a href="190nationstable.php">
                        <div class="card" style="margin-bottom:15px;height:100%">
                            <!-- Card body -->
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="mb-20">190 Nations Table</h5>
