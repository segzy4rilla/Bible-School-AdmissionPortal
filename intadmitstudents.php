...
<head>
    ...
    <!-- Title -->
    <title>ABMTC International Student Responsibility</title>
    ...
    <div class="container overflow-hidden">
      <!--multisteps-form-->
            <form class="multisteps-form__form" id="myForm" name="applicantform" action="PHP_Files/Application_Form_Submission.php"
                                          ...
                                          <h3 class="multisteps-form__title">INTERNATIONAL STUDENT RESPONSIBILITY FORM</h3>

                                          <br>

                                          <h5 class="multisteps-form__title">ABMTC INTERNATIONAL STUDENT RESPONSILIBILITY AGREEMENT FORM</h5>

                                          <br>

                                          <div class="form-group">
                                            <label for="exampleInputName1">Applicants Full Name:</label>
                                            <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter applicants full name" name="intappfullname" required>
                                        </div>
                                            ...
                                            <div class="form-group">
                                              ...
                                              <label>Is He/She Born Again?</label>

                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio1born" name="intbornagain" class="custom-control-input" required>
                                                    <label class="custom-control-label" for="customRadio1born">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio2born" name="intbornagain" class="custom-control-input">
                                                    <label class="custom-control-label" for="customRadio2born">No</label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <label>Has He/She Been In Church More Than One Year?</label>

                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio1one" name="intchurchoneyear" class="custom-control-input" onclick="show1();">
                                                    <label class="custom-control-label" for="customRadio1one" required>Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio2one" name="intchurchoneyear" class="custom-control-input" onclick="show2();" id="noCheck">
                                                    <label class="custom-control-label" for="customRadio2one">No</label>
                                                </div>
                                                ...
                                                <div id="div1" class="form-group hide">

                                                  <label>If Not, Please Specify</label>

                                                <input type="text" class="form-control" placeholder="" name="intlessoneyear">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <label>Does He/She Have The Call Of God On His/Her life?</label>

                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio1call" name="intcallofgod" class="custom-control-input">
                                                    <label class="custom-control-label" for="customRadio1call" required>Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio2call" name="intcallofgod" class="custom-control-input">
                                                    <label class="custom-control-label" for="customRadio2call">No</label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <label>Does He/She Have History Of The Following?</label>

                                              <br>
                                            <span class="help-block"><small>- Narcotic Drug Usage</small></span>
                                            <br>
                                            <span class="help-block"><small>- Homosexuality/Lesbianism</small></span>
                                            <br>
                                            <span class="help-block"><small>- Mental Illness</small></span>
                                            <br>
                                            <span class="help-block"><small>- Criminal Record</small></span>

                                            <br>

                                                <div class="custom-control custom-radio" style="margin-top: 10px;">
                                                    <input type="radio" id="customRadio1hist" name="inthistoryfollow" class="custom-control-input">
                                                    <label class="custom-control-label" for="customRadio1hist" required>Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio2hist" name="inthistoryfollow" class="custom-control-input">
                                                    <label class="custom-control-label" for="customRadio2hist">No</label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <label>Are You His/Her Primary Sponsor?</label>


                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio1primspon" name="intprimarysponsor" class="custom-control-input" onclick="show3();">
                                                    <label class="custom-control-label" for="customRadio1primspon"required>Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio2primspon" name="intprimarysponsor" class="custom-control-input" onclick="show4();">
                                                    <label class="custom-control-label" for="customRadio2primspon">No</label>
                                                </div>

                                                <br>

                                                <div id="div2" class="form-group hide">

                                                  <label>If not, are you willing to step in to help in the case when the primary sponsor is unable   to continue with the sponsorship?</label>

                                                <input type="text" class="form-control" placeholder="" name="inthelpsponsor">
                                        ...
                                        <div class="form-group row">
                                          <label for="example-search-input" class="col-sm-1 col-form-label">I</label>
                                                <div class="col-sm-2">
                                                <select class="form-control rounded-0 form-control-md" id="exampleSelect1" name="intleadertitle">
                                              ...
                                              <div class="col-sm-4">
                                                <input type="text" class="form-control" id="exampleInputEmail111" placeholder="Enter full name" name="intnameofpastor" required>
                                              </div>                                              
                                              <p class="col-sm-4">
                                        Personally know the above-mentioned applicant.  
                                            ...
                                            <div class="form-group">
                                              ...
                                              <label>Please Read The Following Below:</label>

                                            <textarea class="form-control" id="exampleTextarea" rows="5" disabled>
A. I understand that my ward maybe dismissed for the following:
Narcotic Drug Usage, Smoking, Use of alcohol, Stealing, Fornication, Absenteeism from lectures, Exam  Malpractice, Misuse or abuse of accommodation facility assigned to him/her, persistent poor academic performance, rudeness and disrespectful behavior and any other behaviors incompatible with someone training to become a pastor.

B. I understand that the authorities of ABMTC will not hesitate to send away immediately any student who shows signs of mental instability, Drug abuse, Drug addiction or relapsing into any known medical condition he failed to declare during the initial application vetting process. ABMTC reserves the right to unilaterally take this decision because the facility was not built to take care of the mentally challenged.

C. In the case of dismissal of my Ward I take responsibility to ensure that arrangements is made for him/her to be returned home immediately.
                                            </textarea>
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="intadmitsignature" required>
                                        </div>
                                        <br>
                                        <br>

                                        <button class="btn btn-primary ml-auto" style="float: right;" type="submit" title="Send">Submit</button>
