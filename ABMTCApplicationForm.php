              ...
              <div class="multisteps-form__panel shadow p-4 rounded bg-white js-active" data-animation="scaleIn" disabled>
                                               ...
                                               <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="question8" class="form-control required"
                                                           placeholder="Enter marital status" aria-required="true" required="">
                ...
                <div class="is-helpful" data-helper="Validates if not empty." data-error="Please enter your first name."></div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="question9" class="form-control required"
                                                           placeholder="Enter your country" aria-required="true" required="">
...
6. Start Prophylactic Anti Malaria Medications two weeks before leaving your country. Please obtain enough dosages to continue for another 6 weeks whilst in Ghana.
              ...
              <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                ...
                <div class="scrollpage1" style="height: 300px;">
                                                ...
                                                <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    <label>I Am Recommended By (Local Church Pastor, General Overseer, Senior Associate, Pastor, Bishop or Other)</label>
                                                    <input type="text" class="form-control required" name="question74"
                                                           aria-describedby="emailHelp" placeholder="Enter who you were recommended by">
                                                </div>
                                              </div>
