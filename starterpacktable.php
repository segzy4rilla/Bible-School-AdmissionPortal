...
$query = "SELECT A.First_Name, A.Last_Name, C.Nationality, B.Int_WantsStarterPack
...
<head>
    ...
    <!-- Title -->
    <title>Starter Packs Table</title>
            ...
            <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12 box-margin">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-2">Starter Pack Table</h4>
                                        <p class="text-muted font-13 mb-4">
                                            Results of confirmed starter packs
                                        </p>
                                        ...
                                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                            <thead>
                                                <tr>
                                                    <th>Name</th>
                                                    <th>Nationality</th>
                                                    <th>Confirmed yes to starter packs</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
													while ($row = $result->fetch_assoc()) {
														...
														echo "<td>" . $row['Int_WantsStarterPack'] . "</td>";
													}
												?>
                                            </tbody>
                                        </table>
