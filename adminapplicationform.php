...
<head>
    ...
    <!-- Title -->
    <title>ABMTC - Admin Application Form</title>
                                        ...
                                        <div class="overflow-auto">
                                            ...
                                            <section class="overflow-auto">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter first name" disabled>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control rounded-0 form-control-md" type="date" value="2011-08-19" id="example-date-input" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Enter age" disabled>
                                                </div>

                                                <div class="form-group">
                                                    <label class="control-label">Nationality At Birth</label>
                                                    <input type="text" class="form-control" placeholder="Enter birth nationality" disabled>
                                                </div>

                                                <div class="form-group">
                                                    <label class="control-label">Is Your Church Part Of UD-OLGC?</label>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="customUD" name="customRadioUD"
                                                               class="custom-control-input" disabled>
                                                        <label class="custom-control-label" for="customUD">Yes</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="customUD2" name="customRadioUD"
                                                               class="custom-control-input" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleSelectGender" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter residential address" disabled>
                                                </div>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                elit. Pariatur praesentium perspiciatis vero, atque
                                                                dolorum quaerat libero beatae cumque, dignissimos illo
                                                                fugiat. Molestias officia delectus possimus dignissimos
                                                                culpa ab asperiores rem. Ea odit earum blanditiis
                                                                itaque, repellat ab consequatur. Est quis suscipit iusto
                                                                harum maxime ratione, minima sed veritatis, error
                                                                perferendis optio at nobis impedit quidem ad rerum, amet
                                                                voluptatibus soluta!
                                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter whatsapp number" disabled>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter profession" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">What Work Are You Doing Currently?</label>
                                                    <input type="text" class="form-control" placeholder="Enter current work" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Name Of Father</label>
                                                    <input type="number" class="form-control" placeholder="Enter name of your father" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Name Of Mother</label>
                                                    <input type="number" class="form-control" placeholder="Enter name of your mother" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Name Of Guardian</label>
                                                    <input type="number" class="form-control" placeholder="Enter name of your guardian" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Profession Of Father</label>
                                                    <input type="number" class="form-control" placeholder="Enter profession of your father" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Profession Of Mother</label>
                                                    <input type="number" class="form-control" placeholder="Enter profession of your mother" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Profession Of Guardian</label>
                                                    <input type="number" class="form-control" placeholder="Enter profession of your guardian" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Where Do You Live?</label>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiocity1" name="customRadiocity"
                                                               class="custom-control-input" disabled>
                                                        <label class="custom-control-label"
                                                               for="radiocity1">City</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiotown1" name="customRadiocity"
                                                               class="custom-control-input" disabled>
                                                        <label class="custom-control-label"
                                                               for="radiotown1">Town</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiovillage1" name="customRadiocity"
                                                               class="custom-control-input" disabled>
                                                        <label class="custom-control-label"
                                                               for="radiovillage1">Village</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radioslum1" name="customRadiocity"
                                                               class="custom-control-input" disabled>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">Do Your Parents/Guardian Own A
                                                        House?</label>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radioownhouse1"
                                                               name="customRadioownhouse" class="custom-control-input"
                                                               disabled>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">Are Your Parents/Guardian Renting A
                                                        House?</label>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiorent1" name="customRadiorent"
                                                               class="custom-control-input" disabled>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">Do Your Parents/Guardian Own A
                                                        Car?</label>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiocar1" name="customRadiocar"
                                                               class="custom-control-input" disabled>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">Do Your Parents/Guardian Own A
                                                        Business?</label>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiobusiness1"
                                                               name="customRadiobusiness" class="custom-control-input"
                                                               disabled>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Enter sponsor name" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Sponsor Phone Number</label>
                                                    <input type="number" class="form-control" placeholder="Enter sponsor phone number" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Next Of Kin</label>
                                                    <input type="text" class="form-control" placeholder="Enter next of kin" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Next Of Kin Contact Number</label>
                                                    <input type="number" class="form-control" placeholder="Enter next of kin contact number" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Select Course You Would Like To
                                                        Do?</label>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiocourse1" name="customRadiocourse"
                                                               class="custom-control-input" disabled>
                                                        <label class="custom-control-label" for="radiocourse1">9 Months
                                                            Ordinary Program</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiocourse2" name="customRadiocourse"
                                                               class="custom-control-input" disabled>
                                                        <label class="custom-control-label" for="radiocourse2">18 Months
                                                            Standard Program</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiocourse3" name="customRadiocourse"
                                                               class="custom-control-input" disabled>
                                                        <label class="custom-control-label" for="radiocourse3">27 Months
                                                            Premium Program</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiocourse4" name="customRadiocourse"
                                                               class="custom-control-input" disabled>
                                            ...
                                            <section class="overflow-auto">
                                                ...
                                                <div id="bornagain" class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiocall1" name="customRadioborn"
                                                               class="custom-control-input" disabled>
                                                        <label class="custom-control-label" for="radiocall1">Yes</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiocall2" name="customRadioborn"
                                                               class="custom-control-input" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" aria-describedby="emailHelp"
                                                           placeholder="Enter church name" disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label>Which Role Do You Play In Your Church?</label>
                                                    <input type="text" class="form-control"
                                                           placeholder="Enter church role" disabled>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <section class="overflow-auto">
                                                ...
                                                <label for="exampleTextarea1">Why Do You Want To Come To The Bible
                                                    School?</label>
                                                <textarea class="form-control" id="exampleTextarea1" rows="3" disabled>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiocalling1" name="customRadiocalling2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radiocalling1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiocalling2" name="customRadiocalling2" class="custom-control-input" disabled>
                                            ...
                                            <section class="overflow-auto">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radionardrugs1" name="customRadionardrugs2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radionardrugs1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radionardrugs2" name="customRadionardrugs2" class="custom-control-input" disabled>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radionardrugspast1" name="customRadionardrugspast2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radionardrugspast1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radionardrugspast2" name="customRadionardrugspast2" class="custom-control-input" disabled>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radioarrest1" name="customRadioarrest2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radioarrest1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radioarrest2" name="customRadionarrest2" class="custom-control-input" disabled>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radioprose1" name="customRadioprose2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radioprose1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radioprose2" name="customRadioprose2" class="custom-control-input" disabled>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiojail1" name="customRadiojail2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radiojail1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiojail2" name="customRadiojail2" class="custom-control-input" disabled>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radioalcholic1" name="customRadioalcholic2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radioalcholic1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radioalcholic2" name="customRadioalcholic2" class="custom-control-input" disabled>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radioalcholicpast1" name="customRadioalcholicpast2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radioalcholicpast1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radioalcholicpast2" name="customRadioalcholicpast2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radioalcholicpast2">No</label>
                                                </div>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiovirgin1" name="customRadiovirgin2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radiovirgin1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiovirgin2" name="customRadiovirgin2" class="custom-control-input" disabled>
                                                ...
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1forn"
                                                               id="checkbox-p-2forn" disabled>
                                                        <label for="checkbox-p-2forn" class="cr">Fornication</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1ad" id="checkbox-p-2ad"
                                                               disabled>
                                                ...
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1ab" id="checkbox-p-2ab"
                                                               disabled>
                                                ...
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1mas"
                                                               id="checkbox-p-2mas" disabled>
                                                        <label for="checkbox-p-2mas" class="cr">Masturbation</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1porno"
                                                               id="checkbox-p-2porno" disabled>
                                                        <label for="checkbox-p-2porno" class="cr">Pornography</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1homo"
                                                               id="checkbox-p-2homo" disabled>
                                                        <label for="checkbox-p-2homo" class="cr">Homosexuality</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1les"
                                                               id="checkbox-p-2les" disabled>
                                                        <label for="checkbox-p-2les" class="cr">Lesbianism</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1none"
                                                               id="checkbox-p-2none" disabled>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiorob1" name="customRadiorob2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radiorob1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiorob2" name="customRadiorob2" class="custom-control-input" disabled>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiorev1" name="customRadiorev2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radiorev1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiorev2" name="customRadiorev2" class="custom-control-input" disabled>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiopros1" name="customRadiopros2" class="custom-control-input" disabled>
                                                    <label class="custom-control-label" for="radiopros1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiopros2" name="customRadiopros2" class="custom-control-input" disabled>
                                            ...
                                            <section class="overflow-auto">
                                                ...
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1asthma"
                                                               id="checkbox-p-2asthma" disabled>
                                                        <label for="checkbox-p-2asthma" class="cr">Asthma</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1allergy"
                                                               id="checkbox-p-2allergy" disabled>
                                                        <label for="checkbox-p-2allergy" class="cr">Allergy</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1otherallergy"
                                                               id="checkbox-p-2otherallergy" disabled>
                                                ...
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1drugallergy"
                                                               id="checkbox-p-2drugallergy" disabled>
                                                ...
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1diabetes"
                                                               id="checkbox-p-2diabetes" disabled>
                                                        <label for="checkbox-p-2diabetes" class="cr">Diabetes</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1hypertension"
                                                               id="checkbox-p-2hypertension" disabled>
                                                ...
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1tb" id="checkbox-p-2tb"
                                                               disabled>
                                                ...
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1mental"
                                                               id="checkbox-p-2mental" disabled>
                                                        <label for="checkbox-p-2mental" class="cr">Mental</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1illness"
                                                               id="checkbox-p-2illness" disabled>
                                                        <label for="checkbox-p-2illness" class="cr">Illness</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1epilepsy"
                                                               id="checkbox-p-2epilepsy" disabled>
                                                        <label for="checkbox-p-2epilepsy" class="cr">Epilepsy</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="checkbox-p-1sick"
                                                               id="checkbox-p-2sick" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radioaller1" name="customRadioaller2"
                                                               class="custom-control-input" disabled>
                                                        <label class="custom-control-label"
                                                               for="radioaller1">Yes</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radioaller2" name="customRadioaller2"
                                                               class="custom-control-input" disabled>
                                            ...
                                            <section class="overflow-auto">
                                                <div class="form-group">
                                                    <label class="control-label">Have You Had Any Problems With The
                                                        Law?</label>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiolaw1" name="customRadiolaw2"
                                                               class="custom-control-input" disabled>
                                                        <label class="custom-control-label" for="radiolaw1">Yes</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radiolaw2" name="customRadiolaw2"
                                                               class="custom-control-input" disabled>
