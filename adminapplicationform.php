        ...
        <div class="row">
          <div class="col-12 col-lg-12 ml-auto mr-auto mb-4">
            <div class="multisteps-form__progress">
              ...
              <button class="multisteps-form__progress-btn js-active" style="cursor: pointer;" type="button" title="User Info">GENERAL</button>
              <button class="multisteps-form__progress-btn" style="cursor: pointer;" type="button" title="Address">CHURCH</button>
              <button class="multisteps-form__progress-btn" style="cursor: pointer;" type="button" title="Order Info">CALLING</button>
              <button class="multisteps-form__progress-btn" style="cursor: pointer;" type="button" title="Comments">SOCIAL AND PAST</button>
              <button class="multisteps-form__progress-btn" style="cursor: pointer;" type="button" title="Comments">HEALTH STATUS</button>
              <button class="multisteps-form__progress-btn" style="cursor: pointer;" type="button" title="Comments">CRIMINAL HISTORY</button>
              <button class="multisteps-form__progress-btn" style="cursor: pointer;" type="button" title="Comments">NATIONALITY</button>
              <button class="multisteps-form__progress-btn" style="cursor: pointer;" style="font-size: 13px;" type="button" title="Comments">RECOMMENDED BY</button>
              <button class="multisteps-form__progress-btn" style="cursor: pointer;" type="button" title="Comments">FINISH</button>
            </div>
          </div>
        </div>
        <!--form panels-->
        <div class="row">
          <div class="col-12 col-lg-12 m-auto">
            <form class="multisteps-form__form" id="myForm" name="applicantform" action="PHP_Files/Application_Form_Submission.php"
                ...
                <div class="relative input-wrap is-required">
                  <div class="form-group">
                                                    ...
                                                    <input type="text" name="question1" class="form-control required"
                                                           placeholder="Enter first name" aria-required="true" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="question2" class="form-control required"
                                                           placeholder="Enter last name" aria-required="true" disabled>
              ...
              <select class="form-control" name="question6" id="nationatbirth" disabled>
                                                    ...
                                                    <div class="form-group">
                                                       <div class="relative input-wrap is-required"> 
                                                        <select class="form-control rounded-0 required" name="question8"
                                                                id="MaritalStat" disabled>
                                                            <option id="myDropdown1" value="0">--Select Marital Status--</option>    
                                              ...
                                              <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question20"
                                                           placeholder="Enter profession of your guardian" disabled>
                                                </div>
                                              </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question10"
                                                           placeholder="Enter residential address" disabled>
                                                </div>
                                              </div>
                                              ...
                                              <div class="relative input-wrap is-required">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question12"
                                                           placeholder="Enter whatsapp number" disabled>
                                                </div>
                                              </div>
                                              ...
                                              <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="question13"
                                                           placeholder="Enter profession" disabled>
                                                </div>
                                              </div>
                                              ...
                                              <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question14"
                                                           placeholder="Enter current work" disabled>
                                                </div>
                                              </div>
                                              ...
                                              <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question15"
                                                           placeholder="Enter name of your father" disabled>
                                                </div>
                                              </div>
                                              ...
                                              <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question16"
                                                           placeholder="Enter name of your mother" disabled>
                                                </div>
                                              </div>
                                              ...
                                              <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question17"
                                                           placeholder="Enter name of your guardian" disabled>
                                                </div>
                                              </div>
                                              ...
                                              <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question18"
                                                           placeholder="Enter profession of your father" disabled>
                                                </div>
                                              </div>
                                              ...
                                              <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question19"
                                                           placeholder="Enter profession of your mother" disabled>
                                                </div>
                                              </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radioownhouse1" name="question22"
                                                               value="Yes" class="custom-control-input required" disabled>
                                                        <label class="custom-control-label"
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radioownhouse2" name="question22"
                                                               value="No" class="custom-control-input" disabled>
                                                        <label class="custom-control-label"
                                              ...
                                              <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question26"
                                                           placeholder="Enter sponsor name" disabled>
                                                </div>
                                              </div>
                                              ...
                                              <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control required" name="question27"
                                                           placeholder="Enter sponsor phone number" disabled>
                                                </div>
                                              </div>
                                              ...
                                              <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question28"
                                                           placeholder="Enter next of kin" disabled>
                                                </div>
                                              </div>
                    ...
                    <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="radioborn1" name="question32"
                                                               value="Yes" class="custom-control-input" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question34"
                                                           aria-describedby="emailHelp" placeholder="Enter church name" disabled>
                                                </div>
                                              </div>
                                              <div class="relative input-wrap is-required">
                                                <div class="form-group">
                                              ...
                                              <div class="relative input-wrap is-required"> 
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="question36"
                                                           placeholder="Enter how long you have been pastoring" disabled>
                                                </div>
                                              </div>
                  </div>
                  <div class="button-row d-flex mt-4">
              ...
              <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                ...
                <div class="scrollpage1" style="height: 300px;">
                  <label for="exampleTextarea1">Do You Use Narcortic Drugs (Cocaine,
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radioarrest1" name="question44" value="Yes" class="custom-control-input" onclick="show4a();" disabled>
                                                    <label class="custom-control-label" for="radioarrest1">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radioarrest2" name="question44" value="No" class="custom-control-input" onclick="show4();" disabled>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radioalcholic2" name="question50" value="No"
                                                           class="custom-control-input" onclick="show7();" disabled>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <label class="custom-control-label" for="radiovirgin1" disabled>Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="radiovirgin2" name="question54" value="No"
                                                           class="custom-control-input">
                                                    <label class="custom-control-label" for="radiovirgin2" disabled>No</label>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary d-inline">
                                                        <input type="checkbox" name="question62[]"
                                                               value="Sickle Cell Disease" id="checkbox-p-2sick" disabled>
              ...
              <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                ...
                <div class="scrollpage1" style="height: 300px;">
                  <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="question71" id="RecommendedBy" disabled>
              ...
              <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                ...
                <div class="scrollpage1" style="height: 300px;">
                  <div class="form-check">
                    ...
                    <div class="button-row d-flex mt-4 col-12">
                      <button class="btn btn-primary js-btn-prev" type="button" title="Prev">Prev</button>
                      <button id="clickable" class="btn btn-primary ml-auto" type="submit" title="Send">Submit</button>
                  </div>
                </div>          
