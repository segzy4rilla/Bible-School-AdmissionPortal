...
$query = "SELECT A.First_Name, A.Last_Name, C.Nationality, B.IntCon_PrintedAllDocuments,
			B.IntCon_HasMalariaMedication, B.IntCon_MobilePhoneUnlocked,
			B.IntCon_HasGhanaCharger, B.IntCon_PowerBank, B.IntCon_HasBeddings
...
<head>
    ...
    <!-- Title -->
    <title>Int Students Confirmation Table</title>
            ...
            <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12 box-margin">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-2">International Students Confirmation Table</h4>
                                        <p class="text-muted font-13 mb-4">
                                            Results of international student confirmations
                                        </p>
                                        ...
                                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                            <thead>
                                                <tr>
                                                    <th>Name</th>
                                                    <th>Printed All Requested Documents</th>
                                                    <th>I Have Malaria Medication</th>
                                                    <th>My Mobile Phone Is Unlocked</th>
                                                    <th>I Have 3-Pin/Charger Or An Adaptor</th>
                                                    <th>I Have A Charged Power Bank And Cable For My Phone</th>
                                                    <th>I Have These Beddings</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
													while ($row = $result->fetch_assoc()) {
														echo "<tr>";
															...
															echo "<td>" . $row['IntCon_PrintedAllDocuments'] . "</td>";
															echo "<td>" . $row['IntCon_HasMalariaMedication'] . "</td>";
															echo "<td>" . $row['IntCon_MobilePhoneUnlocked'] . "</td>";
															echo "<td>" . $row['IntCon_HasGhanaCharger'] . "</td>";
															echo "<td>" . $row['IntCon_PowerBank'] . "</td>";
															echo "<td>" . $row['IntCon_HasBeddings'] . "</td>";
														echo "</tr>";
													}
												?>
                                            </tbody>
