<?php
	...
	$query = $conn->prepare("SELECT Int_ConfirmationLetterFilepath,Int_AdmissionContractFormFilepath,Int_StudentResponsibilityFormFilepath,
								Int_AdminFeeProofFilepath,Int_ImmigrationFeeProofFilepath,Int_PassportFilepath,Int_VisaFilepath,
								Int_VisaNotRequiredComment,Int_FlightTicketFilepath,Int_DeclarationFormFilepath,Int_RoomAssignmentFormFilepath 
                            ...
                            <div class="card-body" style="margin-left: 0.9%">
								...
								<div style="margin-left: 1%; margin-right: 1%">
									...
									<div>
										...
										<?php
											$path = trim($uploads['Int_ConfirmationLetterFilepath']);
											if(!empty($path)){
									...
									<div>
										<div>
											<h3>Admission Contract Form</h3>
										</div>
										<?php
											$path = trim($uploads['Int_AdmissionContractFormFilepath']);
											if(!empty($path)){
												$path = str_replace('../../', '../', $path);
												echo "<embed src='".$path."' width='90%' height='1000em'/>";
											}
										?>
										<div>
											<h3>Student Responsibility Form</h3>
										</div>
										<?php
											$path = trim($uploads['Int_StudentResponsibilityFormFilepath']);
											if(!empty($path)){
												$path = str_replace('../../', '../', $path);
												echo "<embed src='".$path."' width='90%' height='1000em'/>";
											}
										?>
										<div>
											<h3>Admin Fee Proof</h3>
										</div>
										<?php
											$path = trim($uploads['Int_AdminFeeProofFilepath']);
											if(!empty($path)){
												$path = str_replace('../../', '../', $path);
												echo "<embed src='".$path."' width='90%' height='1000em'/>";
											}
										?>
										<div>
											<h3>Immigration Fee Proof</h3>
										</div>
										<?php
											$path = trim($uploads['Int_ImmigrationFeeProofFilepath']);
											if(!empty($path)){
												$path = str_replace('../../', '../', $path);
												echo "<embed src='".$path."' width='90%' height='1000em'/>";
											}
										...
										<?php
											$path = trim($uploads['Int_PassportFilepath']);
											if(!empty($path)){
												$path = str_replace('../../', '../', $path);
												echo "<embed src='".$path."' width='90%' height='1000em'/>";
											}
										...
										<?php
											$path = trim($uploads['Int_VisaFilepath']);
											if(!empty($path)){
												$path = str_replace('../../', '../', $path);
												echo "<embed src='".$path."' width='90%' height='1000em'/>";
											}
											else{
												echo "<textarea type='text' class='form-control' readonly>".$uploads['Int_VisaNotRequiredComment']."</textarea>";
											}
										?>
										<div>
											<h3>Flight Ticket</h3>
										...
										<?php
											$path = trim($uploads['Int_FlightTicketFilepath']);
											if(!empty($path)){
												$path = str_replace('../../', '../', $path);
												echo "<embed src='".$path."' width='90%' height='1000em'/>";
											}
										...
										<?php
											$path = trim($uploads['Int_DeclarationFormFilepath']);
											if(!empty($path)){
												$path = str_replace('../../', '../', $path);
												echo "<embed src='".$path."' width='90%' height='1000em'/>";
											}
										?>
										<div>
											<h3>Room Assignment Form</h3>
										</div>
										<?php
											$path = trim($uploads['Int_RoomAssignmentFormFilepath']);
											if(!empty($path)){
												$path = str_replace('../../', '../', $path);
												echo "<embed src='".$path."' width='90%' height='1000em'/>";
											}
